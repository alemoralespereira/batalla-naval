class Consultas {
    ...
    existeSala(idSala, callback) {
        ...
        this.conexion.query(query, [idSala], (error, resultados) => {
            if(error) {
                return;
            }
    ...
    insertarDatosSala(idSala,  nombreUsuario, rol, fecha, callback) {
        ...
        this.conexion.query(query, [idSala, nombreUsuario, rol, fecha], (error, resultados) => {
            if (error) {
                callback(error, null);
                return;
            }
    ...
    actualizarDatosSala(idSala, nombreUsuario, rol, fecha, callback) {
        ...
        this.conexion.query(query, [idSala, nombreUsuario, rol, fecha, idSala, rol], (error, resultados) => {
            if (error) {
                callback(error, null);
                return;
            }
    ...
    insertarDatosEntidades(idSala, idEntidad, posX, posY, angulo, velocidad, velocidadMaxima, aceleracion, combustible, piloto, observador, operador, salud, numeroAvion, torpedo, multiplicadorCombustible, despego, callback) {
        ...
        this.conexion.query(query, [idSala, idEntidad, posX, posY, angulo, velocidad, velocidadMaxima, aceleracion, combustible, piloto, observador, operador, salud, numeroAvion, torpedo, multiplicadorCombustible, despego], (error, resultados) => {
            if (error) {
                callback(error, null);
                return;
            }
    ...
    actualizarDatosEntidades(idSala, idEntidad, posX, posY, angulo, velocidad, velocidadMaxima, aceleracion, combustible, piloto, observador, operador, salud, numeroAvion, torpedo, multiplicadorCombustible, despego, callback) {
        ...
        this.conexion.query(query, [idSala, idEntidad, posX, posY, angulo, velocidad, velocidadMaxima, aceleracion, combustible, piloto, observador, operador, salud, numeroAvion, torpedo, multiplicadorCombustible, despego, idSala, idEntidad], (error, resultados) => {
            if (error) {
                callback(error, null);
                return;
            }
